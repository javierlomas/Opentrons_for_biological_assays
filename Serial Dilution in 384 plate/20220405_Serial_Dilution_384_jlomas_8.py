...
def run(ctx):
    ...
    tiprack = [ctx.load_labware('opentrons_96_tiprack_20ul', '1'),ctx.load_labware('opentrons_96_tiprack_20ul', '4'),ctx.load_labware('opentrons_96_tiprack_20ul', '7'),ctx.load_labware('opentrons_96_tiprack_20ul', '10')]
